                ...
                <c:forEach items="${list}" var="list">
                    <div role="tabpanel" class="tab-pane blog-page active" id="mypost">
                        <div class="card single_post">
                            <div class="body">
                                <h3 class="m-t-0 m-b-5"><a href="${list.weburl}">${list.title}</a></h3>
                                <ul class="meta">
                                    <li><a href="#"><i class="zmdi zmdi-account col-blue"></i>${list.originweb}</a></li>
                                    <li><a href="#" style="font-size: smaller;"><i class="zmdi zmdi-label col-red"></i>${list.date}</a></li>
                            ...
                            <div class="body">
                                ...
                                <a href="${list.weburl}" target="_blank" title="read more" class="btn btn-round btn-info">来源</a>
